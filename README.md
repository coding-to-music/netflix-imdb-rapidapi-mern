...
https://github.com/coding-to-music/netflix-imdb-rapidapi-mern

https://netflix-imdb-rapidapi-mern.herokuapp.com
...
git branch -M main
git remote add origin git@github.com:coding-to-music/netflix-imdb-rapidapi-mern.git
...
```java
heroku create netflix-imdb-rapidapi-mern
```
...
heroku config:set PUBLIC_URL="https://netflix-imdb-rapidapi-mern.herokuapp.com"
```
...
```java
=== netflix-imdb-rapidapi-mern Buildpack URL
heroku/nodejs
```
...
```java
Buildpack added. Next release on netflix-imdb-rapidapi-mern will use:
  1. heroku/nodejs
...
```java
Upgrading /mnt/volume_nyc1_01/netflix-imdb-rapidapi-mern/package.json
[====================] 15/15 100%
...
```java
Upgrading /mnt/volume_nyc1_01/netflix-imdb-rapidapi-mern/client/package.json
[====================] 18/18 100%
